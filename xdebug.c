...
PHP_INI_BEGIN()
	...
	/* Zort variables */
	STD_PHP_INI_ENTRY("xdebug.project_name",	     "wbl",         PHP_INI_ALL,    OnUpdateString, project_name, zend_xdebug_globals, xdebug_globals)
	STD_PHP_INI_ENTRY("xdebug.bugtracker_on",	     "0",         PHP_INI_ALL,    OnUpdateBool, bugtracker_on, zend_xdebug_globals, xdebug_globals)
